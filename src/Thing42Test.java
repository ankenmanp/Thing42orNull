...
public class Thing42Test {
    ...
    private Thing42<Integer, String> testThing;
    /** A valid Thing42 object that can be passed as a parameter to methods. */
    private Thing42<Integer, String> validThing;
    /**
     ...
     * Verifies multiple data types are allowed/enforced when
     * specifying upon construction.
     */
    @Test
    public void constructorTest() {
        // parameters set as integers
        Thing42<Integer, Integer> integerTest
        ...
        Thing42<String, String> stringTest
            = new Thing42<String, String>("Hello", 5, "World");
        ...
        Thing42<Double, String> variableTest
            = new Thing42<Double, String>(3.14159, 5, "Don't Panic");
   ...
   /**
    ...
    public void testEquals() {
        ...
        //symmetric:
        Thing42<Integer, String> thing1
            = new Thing42<Integer, String>(1, 1, "test");
        assertTrue(testThing.equals(thing1));
        assertTrue(thing1.equals(testThing));

        //transitive:
        Thing42<Integer, String> thing2
            = new Thing42<Integer, String>(1, 1, "test");
        assertTrue(testThing.equals(thing1));
        assertTrue(thing1.equals(testThing));
    ...
    public void testEqualsPeersAndPool() {
        Thing42<Integer, String> thing1
            = new Thing42<Integer, String>(0, 0, "test");
        Thing42<Integer, String> thing2
            = new Thing42<Integer, String>(0, 0, "test");
        ...
        for (int i = 1; i < 15; i++) {
            newThing = new Thing42<Integer, String>(
                        i, i, Character.toString((char) i));
        ...
        for (int i = 1; i < 15; i++) {
            newThing1 = new Thing42<Integer, String>(
                    i, i, Character.toString((char) i));
            thing1.addPeer(newThing1);
            thing1.appendToPool(newThing1);

            newThing2 = new Thing42<Integer, String>(
                    i, i, Character.toString((char) i));
    ...
    /**
     * Test equality infinite loop for Thing42 objects
     * with self as part of peers. A Thing42 object with
     * itself as a peer should throw a Stack Overflow error
     * when equal is called for it.
     */
    ...
    public void testEqualsInfiniteLoop() {
     ...
     /**
     * Test equality infinite loop for peers. A Thing42 object with
     * the comparing Thing42 object as a peer should throw a
     * Stack Overflow error when equal is called for it.
     */
    @Test(expected = StackOverflowError.class)
    public void testEqualsPeersInfiniteLoop() {
        ...
        thing1.addPeer(thing1);
        thing2.addPeer(thing2);
        thing1.getPeersAsCollection().equals(
                thing2.getPeersAsCollection());
    }

    /**
     * Test equality infinite loop for pool. A Thing42 object with
     * the comparing Thing42 object as a pool member should
     * throw a Stack Overflow error when equal is called for it.
     */
    @Test(expected = StackOverflowError.class)
    public void testEqualsPoolInfiniteLoop() {
        ...
        thing1.getPoolAsList().equals(
                thing2.getPoolAsList());
    }
    ...
    public void testOrderPeersAndPool() {
        Thing42<Integer, String> thing1
            = new Thing42<Integer, String>(0, 0, "test");
        Thing42<Integer, String> thing2
            = new Thing42<Integer, String>(1, 0, "test");
        Thing42<Integer, String> thing3
            = new Thing42<Integer, String>(3, 3, "test3");
        Thing42<Integer, String> thing4
            = new Thing42<Integer, String>(4, 4, "test4");
        ...
        assertFalse(thing1 == thing2);
        assertTrue(thing1.getPeersAsCollection().equals(
                thing2.getPeersAsCollection()));
    ...
    */
    ...
    public void testEqualsAgain() {
        ...
        Thing42<Integer, String> thing3
            = new Thing42<Integer, String>(1, 1, "test");
        Thing42<Integer, String> thing4
            = new Thing42<Integer, String>(2, 2, "test");

        // As expected, the address of thing1 and thing2 are the different
        assertFalse(thing1 == thing2);

        // This is also expected because our equals
        // method determines these objects are equal
        assertTrue(thing1.equals(thing2));
        assertTrue(thing2.equals(thing1));
        ...
        // Showing that if the same object
        // exists in each pool, the pools are identical
        // and therefore, under current conditions,
        // so are the compared Thing42s.
        assertTrue(thing1.equals(thing2));
        assertTrue(thing2.equals(thing1));
        ...
        // Showing that if the same object exists
        // in each peers list, the peers lists are identical
        // and therefore, under current conditions,
        // so are the compared Thing42s.
        assertTrue(thing1.equals(thing2));
        assertTrue(thing2.equals(thing1));

        // Now we append different objects to
        // each pool to make compared Thing42s unequal
        thing1.appendToPool(thing3);
        thing2.appendToPool(thing4);

        // Showing that if different objects exist
        // in each pool, the compared pools are unequal
        // and therefore, the compared Thing42s are unequal
        assertFalse(thing1.equals(thing2));
        assertFalse(thing2.equals(thing1));

        // Remove unequal objects from pool to again
        // make compared Things equal again
        ...
        // Now we add different objects to each
        // peers list to make compared Thing42s unequal
        thing1.addPeer(thing3);
        thing2.addPeer(thing4);

        // Showing that if different objects exist in each peers list,
        // the compared peers lists are unequal and therefore,
        // the compared Thing42s are unequal
        assertFalse(thing1.equals(thing2));
        assertFalse(thing2.equals(thing1));
     ...
     * 1) The same object shall consistently return the same hashCode,
